...
; ------------------------------------------------------------------------------
	...
	move.w	scroll_x_diff,d4		; Set scroll offset and flags for middle section
	ext.l	d4
	asl.l	#6,d4
	moveq	#6,d6
	bsr.w	SetHorizScrollFlagsBG3

	move.w	scroll_x_diff,d4		; Set scroll offset and flags for bottom section
	ext.l	d4
	asl.l	#7,d4
	moveq	#4,d6
	...
	move.w	scroll_x_diff,d4		; Set scroll offset and flags for lights
	ext.l	d4
	asl.l	#4,d4
	move.l	d4,d3
	add.l	d3,d3
	...
	move.w	camera_bg3_x,d0			; Scroll middle section
	neg.w	d0
	moveq	#$14-1,d6
...
.ScrollMiddle:
	...
	move.w	camera_bg2_x,d0			; Scroll bottom section
	neg.w	d0
	moveq	#$2E-1,d6
...
ScrollBGLights:
	move.w	camera_bg_x,d0			; Get scroll offset
	move.w	camera_fg_x,d2
	sub.w	d0,d2
	ext.l	d2

	moveq	#0,d3				; Prepare to scroll
	move.w	camera_bg_x,d4
...
DrawLevel:
	...
	lea	scroll_flags_bg_copy,a2		; Update background section 1
	lea	camera_bg_x_copy,a3
	lea	map_layout+$40,a4
	move.w	#$6000,d2
	bsr.w	DrawLevelBG1

	lea	scroll_flags_bg2_copy,a2	; Update background section 2
	lea	camera_bg2_x_copy,a3
	bsr.w	DrawLevelBG2

	lea	scroll_flags_bg3_copy,a2	; Update background section 3
