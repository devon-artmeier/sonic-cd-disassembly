...
GetBlockDataAbsXY:
	lea	map_blocks,a1			; Prepare block data pointer
...
PlaceBlockAtPos:
	...
	lea	map_layout,a4			; Prepare level layout
...
ChkBlockPosOnscreen:
	move.w	camera_fg_y,d0			; Is the block above the top of the screen?
	move.w	d0,d1
	andi.w	#$FFF0,d0
	subi.w	#16,d0
	cmp.w	d0,d4
	...
	move.w	camera_fg_x,d0			; Is the block left of the left side of the screen?
	move.w	d0,d1
	andi.w	#$FFF0,d0
	subi.w	#16,d0
	cmp.w	d0,d5
