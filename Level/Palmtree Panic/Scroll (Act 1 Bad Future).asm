...
; By Devon Artmeier
; ------------------------------------------------------------------------------
; Palmtree Panic Act 1 Bad Future level scrolling/drawing
; ------------------------------------------------------------------------------
...
LevelSizeLoad:
	...
	move.w	#$1010,map_block_cross_fg_x	; Initialize block crossed flags
...
.ScrollClouds1:
	...
	move.w	deform_buffer+4,d0		; Scroll middle clouds
	add.w	camera_bg3_x,d0
	neg.w	d0
	move.w	#6-1,d1
...
.ScrollClouds2:
	...
	move.w	deform_buffer+8,d0		; Scroll bottom clouds
	add.w	camera_bg3_x,d0
	neg.w	d0
	move.w	#4-1,d1
...
.ScrollClouds3:
	...
	move.w	#8-1,d1				; Scroll mountains
...
.ScrollBushes:
	...
	move.w	#6-1,d1				; Scroll waterfalls
