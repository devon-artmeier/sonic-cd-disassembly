...
; ------------------------------------------------------------------------------
	...
	move.w	scroll_x_diff,d4		; Set scroll offset and flags for the waterfalls
	ext.l	d4
	asl.l	#4,d4
	move.l	d4,d3
	add.l	d3,d3
	...
	move.w	scroll_x_diff,d4		; Set scroll offset and flags for the rest + vertical scrolling
	ext.l	d4
	asl.l	#7,d4
