...
Functions:
	func FILE_INIT,      InitFileEngine			; Initialize file engine
	func FILE_OPERATION, RunFileOperation			; Perform file operation
	func FILE_STATUS,    GetFileStatus			; Get status
	func FILE_GET_FILES, StartFileTableRead			; Read file table
	func FILE_LOAD_FILE, StartFileLoad			; Load file
	func FILE_FIND_FILE, FindFile				; Find file
	func FILE_FMV,       StartFmvLoad			; Load FMV
	func FILE_RESET,     ResetFileEngine			; Reset file engine
	func FILE_MUTE_FMV,  StartMuteFmvLoad			; Load mute FMV
...
Operations:
	oper FILE_OPERATE_NONE,      FileOperation		; None
	oper FILE_OPERATE_GET_FILES, FileTableOperation		; Read file table
	oper FILE_OPERATE_LOAD_FILE, FileLoadOperation		; Load file
	oper FILE_OPERATE_FMV,       FmvLoadOperation		; Load FMV
	oper FILE_OPERATE_FMV_MUTE,  MuteFmvLoadOperation	; Load mute FMV
...
FileTableOperation:
	move.b	#MCDR_SUB_READ,file.cdc_device(a5)		; Set CDC device destination
...
.TransferData:
	cmpi.b	#MCDR_MAIN_READ,file.cdc_device(a5)		; Should the Main CPU read the sector data?
